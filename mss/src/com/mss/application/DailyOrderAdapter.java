...
public class DailyOrderAdapter extends BaseAdapter implements OnClickListener {
	...
	public DailyOrderAdapter(Context ctx) throws Throwable {
		mContext = ctx;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			v = mLayoutInflater.inflate(R.layout.item_layout_daily_order , null, false);

			holder = new ViewHolder();
			holder.mShippingName = (TextView) v.findViewById(R.id.label_shipping_name);
			holder.mShippingAddress = (TextView) v.findViewById(R.id.label_shipping_address);
		...
		holder.mShippingName.setText(n.getShippingAddressName());
		holder.mShippingAddress.setText(n.getShippingAddressValue());
