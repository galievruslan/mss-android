...
public class ShippingAddressesAdapter extends BaseAdapter implements OnClickListener {
	...
	public ShippingAddressesAdapter(Context ctx) throws Throwable {
		mContext = ctx;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			v = mLayoutInflater.inflate(R.layout.customer_item_layout , null, false);
